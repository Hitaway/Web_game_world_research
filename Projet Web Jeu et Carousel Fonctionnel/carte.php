  ...
  border-top:15px solid #2c3e50;
	...
	<body style="font-family: 'Helvetica Neue', Helvetica, sans-serif ; margin-left: 10px; margin-right: 10px; ">
		...
		<div style="width: auto	; height: 250px; background-color:#DFF2FF;  border-radius: 10px;">
			...
			<div>
					<img id="image_merveille" src="kheops.jpg" style="width:300px;  height: 200px; float:left; padding-bottom: 10px ;margin-left: 200px; overflow: hidden; -webkit-border-radius:30px; -moz-border-radius:30px;">
		      ...
		      <div class="modal-body" >
				  ...
				  <div class="carousel-inner">
				    <div  class="item active">
				      ...
				      <img  id="image1" src="kheops.jpg" style="height: 300px ;width:900px">
				    ...
				    <div class="item">
				      ...
				      <img id="image2" src="kheops2.jpg" style="height: 300px ;width:900px" alt="Chicago">
				    </div>
				    ...
				    <div class="item">
				      ...
				      <img id="image3" src="kheops3.jpg" style="height: 300px ;width:900px" alt="New York">
				    </div>
				  </div>
